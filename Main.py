...
# Practicing using bitwise operators
print("Bitwise practice")
x = 1
y = 2

# bits are shifted to the left by y or in this case 2
print(x << y)
# bits are shifted to the right by y or in this case 2
print(x >> y)
# this will do a bitwise OR
print(x ^ y)
# this will do a bitwise AND
print(x & y)
# this will do a bitwise NOT
print(~x)

# list for all weapons including fists
weapon_list = [6, 5, 7, 2]
print("List of the weapon damages =", weapon_list)
# checking the length of the list since there are 4 values so the length is 4
print("The list is this long =", len(weapon_list))
# indexing the fist in weapon_list
print("The fist damage =", weapon_list[3])
# slicing the weapon_list to get it w/o fist damage
new_weapon_list = (weapon_list[0:3])
print("New weapon only list =", new_weapon_list)
# adding the magic dagger damage
new_weapon_list.insert(0, 9)
print("New new weapon only list =", new_weapon_list)
# adding the lighting book
new_weapon_list.append(15)
print("The completed weapon only list =", new_weapon_list)
# seeing the list sorted by damage ranking
new_weapon_list.sort()
print("The completed and sorted weapon only list =", new_weapon_list)
# indexing the completed list to see where append put the book damage
print("Lets see where the book damage was put", new_weapon_list.index(15))
# lets check the new list length
print("The list is this long now,", len(new_weapon_list))
# deleting the old weapon_list
del weapon_list
# printing the individual values in new_weapon_list by using the for loop
for i in new_weapon_list:
    print("All the damage values", i)
# https://www.w3schools.com/python/python_lists_comprehension.asp
# using list comprehension to see what damage is greater that 6
comprehension_list = [i for i in new_weapon_list if i > 6]
print("The damage greater than 6 =", comprehension_list)
# copying my list to make changes later
comprehension_list_copy = comprehension_list.copy()
print("The list is now copied", comprehension_list_copy)
# showing a tuple in a list
tuple_list = [6, 5, 7, (2, 4)]
print("The list with a tuple", tuple_list)
# a list can also be in a tuple
list_tuple = (6, 5, 7, [2, 3, 4, 5])
print("The tuple with a list", list_tuple)
# here is a list within a list
list_list = [6, 5, 7, [2, 3, 4, 5]]
print("The list with a list", list_list)
# remember tuples cant be changed unlike lists
# indexing a tuple for practice
print("Position of 7 within the tuple =", list_tuple.index(7))
# slicing a tuple for practice
sliced_tuple = list_tuple[0:3]
print("Tuple without the list", sliced_tuple)
# creating an empty dictionary
dictionary_1 = {}
# adding the first key and value to the dictionary
dictionary_1['dagger'] = '9'
dictionary_1['book'] = '15'
print("A clean dictionary for the weapons", dictionary_1)
# checking the values in the dictionary
vals = dictionary_1.values()
print("Just the damage in the dictionary", vals)
# checking the keys in the dictionary
keys = dictionary_1.keys()
print("Just the weapons in the dictionary", keys)
# checking the items in the dictionary
items = dictionary_1.items()
print("Just everything in the dictionary", items)
# using pop() to get rid of book
dictionary_1.pop('book')
print("The book has now been removed from the player", dictionary_1)
